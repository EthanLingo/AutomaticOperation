...
def geturl(Num):
    ...
    url = 'https://www.jianshu.com/writer#/notebooks/49575410/notes/92539080'
    driver.get(url)
    ...
    driver.find_element_by_id(
        "WOS_GeneralSearch_input_form_sb").click()  # 模拟点击检索按钮
...
def html_parse(html, ID):
    ...
    try:
        ...
        cited = tree.xpath(
            "//div[@class='search-results-data-cite']/a/text()")  # 解析页面获取被引量
        download = tree.xpath(
            ".//div[@class='alum_text']/span/text()")  # 解析页面获取下载量
